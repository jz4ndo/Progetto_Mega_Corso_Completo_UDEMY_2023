		...
		<c:choose>
		    ...
		    <c:otherwise>
				<section id="content-main">
					...
					<!-- mostra dei messaggi di conferma se il salvataggio � avvenuto con successo oppure no -->
					<p>
					...
					<form method="post" action="aggiungi_recensione.html">
						...
						<div>
							...
							<!-- carica automaticamente i film che l'utente pu� selezionare -->
						...
						<div>
							...
							<select id="voto_finale" name="voto_finale">
								<!-- genera automaticamente i voti che l'utente pu� selezionare -->
